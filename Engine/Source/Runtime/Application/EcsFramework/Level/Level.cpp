...
#include "Runtime/Application/EcsFramework/System/SystemGroup.h"
// #include "Runtime/Core/Renderer/Renderer2D.h"
...
// 			mSystems.emplace_back(CreateScope<AudioScriptSystem>(this));
	...
	template <>
	void Level::OnComponentAdded<DirectionalLightComponent>(Entity entity, DirectionalLightComponent &component)
	{
    }

	template <>
	void Level::OnComponentAdded<PointLightComponent>(Entity entity, PointLightComponent &component)
	{
    }
